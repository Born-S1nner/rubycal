...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference('Calculation.count') do
      post calculations_url, params: { calculation: { first_input: @calculation.first_input, operation: @calculation.operation, requested_count: @calculation.requested_count, result: @calculation.result, second_input: @calculation.second_input } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { first_input: @calculation.first_input, operation: @calculation.operation, requested_count: @calculation.requested_count, result: @calculation.result, second_input: @calculation.second_input } }
